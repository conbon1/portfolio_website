export const projects = [
  {
    title: 'Sneak Peak #1',
    description: "Genesis Wizards are your key to the Wizard Worlds Metaverse.",
      image: '/images/3.png',
      tags: ['6 different sets of robes', '5 different staves'],
  ...
  {
    title: 'Sneak Peak #2',
    description:"Each staff holds a unique ability granting different bonuses to the holder",
    image: '/images/4.png',
    tags: ['Ice', 'Fire', 'Plasma'],
    source: 'https://google.com',
    visit: 'https://google.com',
    id: 4,
  },
